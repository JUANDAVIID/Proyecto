    ...
    <div class="registration-form">
        <form>
            ...
            <div class="form-group">
                <input type="text" style="border-radius: 20px;background-color:#d0d0d0;box-shadow: 3px 3px 3px 3px"; class="form-control item" id="username" placeholder="Usuario" value="Admin"/>
            </div>
            <div class="form-group">
                <input type="password" style="border-radius: 20px;background-color:#d0d0d0;box-shadow: 3px 3px 3px 3px"; class="form-control item" id="password" placeholder="Contraseña" value="Admin123"/>
            </div>
            <div class="form-group">
