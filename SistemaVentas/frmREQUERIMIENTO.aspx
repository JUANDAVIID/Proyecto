<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaster.Master" AutoEventWireup="true" CodeBehind="frmREQUERIMIENTO.aspx.cs" Inherits="SISTEMATICKET.frmREQUERIMIENTO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header">
                    Mantenedor REQUERIMIENTO
                  </div>
                  <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                                <button id="btnNuevoREQUERIMIENTO" type="button" class="btn btn-sm btn-success">Nuevo</button>
                            </div>
                        </div>
                      <hr />
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                <table id="tbREQUERIMIENTO" class="table table-striped table-bordered nowrap compact" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Codigo</th>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">REQUERIMIENTO</h5>
          ...
          <div class="modal-body">
            <form>
              <input id="txtIdREQUERIMIENTO" class="model" name="IdREQUERIMIENTO" value="0" type="hidden" />
    ...
    <script src="Controlador/frmREQUERIMIENTO/frmREQUERIMIENTO.js"></script>
</asp:Content>
